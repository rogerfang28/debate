...
ui::Page DebatePageGenerator::GenerateDebatePage(user_engagement::UserEngagement engagement) {
    ...
    mainLayout = FillChildClaims(engagement, mainLayout);
    mainLayout = FillChallenges(engagement, mainLayout);
    mainLayout = FillCurrentClaimSection(engagement, mainLayout);
    mainLayout = AddAppropriateButtons(engagement, mainLayout);
    mainLayout = AddAppropriateOverlays(engagement, mainLayout);    
...
ui::Component DebatePageGenerator::FillChildClaims(user_engagement::UserEngagement engagement, ui::Component mainLayout) {
    // should fill child claims section


    return mainLayout;
}
ui::Component DebatePageGenerator::FillChallenges(user_engagement::UserEngagement engagement, ui::Component mainLayout){
    // should fill challenges section

    return mainLayout;
}
ui::Component DebatePageGenerator::FillCurrentClaimSection(user_engagement::UserEngagement engagement, ui::Component mainLayout){
    // should fill current claim section

    return mainLayout;
}
ui::Component DebatePageGenerator::AddAppropriateButtons(user_engagement::UserEngagement engagement, ui::Component mainLayout){
    // should add appropriate buttons based on engagement

    return mainLayout;
}
ui::Component DebatePageGenerator::AddAppropriateOverlays(user_engagement::UserEngagement engagement, ui::Component mainLayout){
    // should add appropriate overlays based on engagement
