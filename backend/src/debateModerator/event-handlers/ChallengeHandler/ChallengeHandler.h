...
public:
    ...
    static void SubmitChallengeClaim(const std::string& challenge_sentence, const std::string& challenge_description, const int& user_id, DebateWrapper& debateWrapper);
    static void ConcedeChallenge(const int& user_id, const int& challenge_link_id, DebateWrapper& debateWrapper);
